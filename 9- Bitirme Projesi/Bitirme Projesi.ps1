...
$secimAl = Read-Host "Lütfen seçim yapınız (0-10)"
...
switch ($secimAl) {
    ...
    default {
        Write-Host "Geçersiz seçim yaptınız. Lütfen 0-10 arasında bir değer giriniz." -ForegroundColor Red
    }
}
